...
const getUserSignUp = ({
  ...
  return dispatch => {
    auth
      .createUserWithEmailAndPassword(doctorEmail, doctorPassword)
      .then(response => {
...
const getUserLogout = () => {
  return dispatch => {
    auth
      ...
      .catch(err =>
        dispatch({ type: Actions.userLogoutError, payload: err.message })
      )
  }
}

export { getUserSignUp, getUserLogin, getUserLogout }
